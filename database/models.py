...
class DetailItem(Base):
    ...
    # previously was string-based account_code, left as is or changed at your convenience
...
class XeroBill(Base):
    ...
    # The relationship to BillLineItem, indicating that BillLineItems reference XeroBill.id as 'parent_id'
...
class BillLineItem(Base):
    ...
    # This is now the ForeignKey to XeroBill.id
    parent_id = Column(
    ...
    # Relationship back to XeroBill, matching bill_line_items on XeroBill
