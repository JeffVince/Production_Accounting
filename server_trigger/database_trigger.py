...
from server_celery.celery_tasks import process_invoice_trigger, process_invoice_delete, process_detail_item_create, \
    process_detail_item_update, process_detail_item_delete, process_purchase_order_create, \
    process_purchase_order_update, process_purchase_order_delete, process_contact_create, process_contact_update, \
    process_contact_delete, process_bill_line_item_create, process_bill_line_item_update, process_bill_line_item_delete, \
    process_bank_transaction_create, process_bank_transaction_update, process_bank_transaction_delete, \
    process_account_code_create, process_account_code_update, process_account_code_delete, process_receipt_create, \
    process_receipt_update, process_receipt_delete, process_spend_money_create, process_spend_money_update, \
    process_spend_money_delete, process_tax_account_create, process_tax_account_update, process_tax_account_delete, \
    process_xero_bill_create, process_xero_bill_delete, process_xero_bill_update
